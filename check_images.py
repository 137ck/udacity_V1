...
def main():
    ...
    solutions_dic = get_pet_labels(in_arg.dir)

    # Function that checks Pet Images in the results Dictionary using results    
    check_creating_pet_image_labels(solutions_dic)
    ...
    results_dic=classify_images(in_arg.dir,solutions_dic,in_arg.arch)
