...
#                                                                             
# PROGRAMMER: 
# DATE CREATED:  Frank Chen                                
# REVISED DATE: 2022.4.5
...
#    
    ...
    dic_of_petlables = dict()
   
    # Processes through each file in the directory, extracting only the words
    # of the file that contain the pet image label
    for num in range(0, len(in_files)):
       ...
       if in_files[num][0] != ".":
           ...
           image_name = in_files[num].split("_")
           ...
           if in_files[num] not in dic_of_petlables:
              dic_of_petlables[in_files[num]] = [pet_label]
